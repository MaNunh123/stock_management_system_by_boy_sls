	...
	class User:public IFeature {
		...
		public:
			//constructor
			User();
			User(int userId , const char *username , const char *email ,const char *password , const char *role);
			//destructor 
			~User();
	...
	istream &operator >> (istream &in, User &obj){
		...
		cout<<"Enter Username : "; getline(in, obj.username); 
	...
	istream &operator >> (istream &in, Supplier &obj){
		cout<<"Enter Supplier ID : "; in>>obj.supId; 
		cout<<"Enter Supplier Name : "; in>>obj.name; 
		cout<<"Enter Supplier Description : "; in>>obj.description; 
		cout<<"Enter Supplier Address : "; in>>obj.address; 
		cout<<"Enter Supplier License : "; in>>obj.license; 
		return in; 
	}
	...
	istream &operator >> (istream &in, Category &obj){
		cout<<"Enter Category ID : "; in>>obj.catId; 
		cout<<"Enter Category Name : "; in>>obj.name; 
		cout<<"Enter Category Description : "; in>>obj.description; 
		return in; 
	}
	...
	istream &operator >> (istream &in, Product &obj){
		cout<<"Enter Product ID : "; in>>obj.catId; 
		cout<<"Enter Product Name : "; in>>obj.name; 
		cout<<"Enter Product Description : "; in>>obj.description;
		cout<<"Enter Product Price : ";in>>obj.price;
		cout<<"Enter Product MadeDate : ";in>>obj.madeAtDate;
		cout<<"Enter Product ExpirationDate : ";in>>obj.expirationDate;
		cout<<"Enter Supplier Id : ";in>>obj.supId;
		cout<<"Enter Supplier Name : ";in>>obj.supName;
		cout<<"Enter Category Id : ";in>>obj.catId;
		cout<<"Enter Category Name : ";in>>obj.catName;
		return in; 
	}
	...
	instream &operator >> (instream &in, Stock &obj){
		cout<<"Enter Stock ID :";in>>obj.stockId;
		cout<<"Enter Stock QTY :";in>>obj.qty;
		cout<<"Enter Product ID :";in>>obj.proId;
		cout<<"Enter Product Name :";in>>obj.proName;
		cout<<"Enter User ID :";in>>obj.userId;
